...
### Detailed steps for deploying and connecting the monitoring web application
...
For technical details, see:
 - [https://github.com/ibm-watson-iot/guide-conveyor/blob/master/README.md ![External link icon](../../../icons/launch-glyph.svg "External link icon")](https://github.com/ibm-watson-iot/guide-conveyor/blob/master/README.md){: new_window}
