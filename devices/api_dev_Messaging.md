...
# HTTP Messaging API for devices
{: #rest_messaging_api}
...
**Important notes:**
- In the current HTTP messaging API version, you can submit device events only by using HTTP messaging. Use the MQTT messaging protocol to submit requests for other device management and control features.
