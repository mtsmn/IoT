...
필수 포트가 열리고 통신에 사용 가능한지 확인하십시오.  8883 및 443 포트는 MQTT 및 HTTP 프로토콜의 TLS를 사용한 보안 연결을 지원합니다. 1883 포트는 MQTT 및 HTTP 프로토콜의 비보안 연결을 지원합니다. HTTP 포트 1883은 기본적으로 사용되지 않습니다. 기본 설정 변경에 대한 정보는 [보안 정책 구성](set_up_policies.html#set_up_policies.html)을 참조하십시오. 

연결 유형 및 연관된 포트 번호에 대한 정보는 다음 표에 요약되어 있습니다.   
...
공유 구독의 형식에 대한 정보는 [애플리케이션용 MQTT 연결](../../applications/mqtt.html)을 참조하십시오. 
