...
|[Mbed TLS 2.4.1 ![外部鏈結圖示](../../../../icons/launch-glyph.svg "外部鏈結圖示")](https://github.com/ARMmbed/mbedtls/archive/mbedtls-2.4.1.tar.gz){: new_window} |提供「SSL 程式庫」，以啟用「TLS 支援」及「用戶端憑證」型鑑別。如需相關資訊，請參閱 [Mbed TLS 中的 SSL 程式庫 ![外部鏈結圖示](../../../../icons/launch-glyph.svg "外部鏈結圖示")](https://tls.mbed.org/ssl-library){: new_window}。|
