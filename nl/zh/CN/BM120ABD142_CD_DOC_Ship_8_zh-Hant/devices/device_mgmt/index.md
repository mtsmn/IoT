...
**重要事項：**裝置必須實作、觀察、通知及取消作業，才能支援[韌體動作 - 更新](requests.html#firmware-actions-update)要求類型。觀察屬性變更要求僅用在韌體要求的環境定義中。
...
**重要事項：**裝置必須實作、觀察、通知及取消作業，才能支援[韌體動作 - 更新](requests.html#firmware-actions-update)要求類型。取消屬性觀察要求僅用在韌體要求的環境定義中。
...
**重要事項：**裝置必須實作、觀察、通知及取消作業，才能支援[韌體動作 - 更新](requests.html#firmware-actions-update)要求類型。通知屬性變更要求僅用在韌體要求的環境定義中。
