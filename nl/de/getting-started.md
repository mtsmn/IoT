...
Sie benötigen ein [Bluemix-Konto ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://console.bluemix.net/registration/){: new_window}, eine Instanz des {{site.data.keyword.iot_short_notm}}-Service und ein Gerät, das folgenden Anforderungen entspricht:
...
Sie können Geräte im {{site.data.keyword.iot_short_notm}}-Dashboard einzeln hinzufügen oder mit der [Watson IoT Platform-API ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://docs.internetofthings.ibmcloud.com/apis/swagger/v0002/org-admin.html#!/Device_Bulk_Configuration/post_bulk_devices_add){: new_window} mehrere Geräte hinzufügen.
